...
<a id="accountanalysis">Account Analysis

</a>- Analyze Processes and Systems for Improvements [JSON](./skills/analyze-processes-and-systems-for-improvements.skill.json)
...
<a id="accountreconciliation">Account Reconciliation

</a>- Data Set Ensurance [JSON](./skills/data-set-ensurance.skill.json)

[Back to Top](#skills)


<a id="accounting">Accounting

</a>- Account Balances Adjustment [JSON](./skills/account-balances-adjustment.skill.json)
...
<a id="accountingethics">Accounting Ethics

</a>- Act Responsibly [JSON](./skills/act-responsibly.skill.json)
...
<a id="accountingmanagement">Accounting Management

</a>- Accounting Method and Policy Enforcement [JSON](./skills/accounting-method-and-policy-enforcement.skill.json)
...
<a id="accountingsoftware">Accounting Software

</a>- Accounting Activities Execution [JSON](./skills/accounting-activities-execution.skill.json)
...
<a id="accountingstandardscodificationasc">Accounting Standards Codification (ASC)

</a>- Generally Accepted Accounting Principles Application [JSON](./skills/generally-accepted-accounting-principles-application.skill.json)

[Back to Top](#skills)


<a id="accountingsystems">Accounting Systems

</a>- Accounting Process Deployment [JSON](./skills/accounting-process-deployment.skill.json)
...
<a id="accountspayable">Accounts Payable

</a>- Disbursement Posting [JSON](./skills/disbursement-posting.skill.json)
...
<a id="accountsreceivable">Accounts Receivable

</a>- Bad Debt Reserves Review [JSON](./skills/bad-debt-reserves-review.skill.json)
...
<a id="accruals">Accruals

</a>- Account Analysis Oversight [JSON](./skills/account-analysis-oversight.skill.json)
...
<a id="activelistening">Active Listening

</a>- Analyze the Need for Active Listening in Various Situations [JSON](./skills/analyze-the-need-for-active-listening-in-various-situations.skill.json)

[Back to Top](#skills)


<a id="agencylaw">Agency Law

</a>- Agency Relationship Identification [JSON](./skills/agency-relationship-identification.skill.json)
...
<a id="analyticaltechniques">Analytical Techniques

</a>- Fact Analysis [JSON](./skills/fact-analysis.skill.json)
...
<a id="antimoneylaundering">Anti Money Laundering

</a>- Bank Transaction Analysis [JSON](./skills/bank-transaction-analysis.skill.json)
...
<a id="auditing">Auditing

</a>- Audit Report Preparation [JSON](./skills/audit-report-preparation.skill.json)
...
<a id="balancesheet">Balance Sheet

</a>- Analysis Management [JSON](./skills/analysis-management.skill.json)
...
<a id="balancedbudgeting">Balanced Budgeting

</a>- Budget Summary and Recommendations [JSON](./skills/budget-summary-and-recommendations.skill.json)
- Cost-Benefit Analysis [JSON](./skills/cost-benefit-analysis.skill.json)

[Back to Top](#skills)


<a id="bankexamination">Bank Examination

</a>- Compliance Action Recommendation [JSON](./skills/compliance-action-recommendation.skill.json)
...
<a id="bankreconciliations">Bank Reconciliations

</a>- Automated Report Creation [JSON](./skills/automated-report-creation.skill.json)
...
<a id="banksecrecyact">Bank Secrecy Act

</a>- Internal Process Management [JSON](./skills/internal-process-management.skill.json)
...
<a id="behavioralscience">Behavioral Science

</a>- Action Prediction [JSON](./skills/action-prediction.skill.json)
...
<a id="bookkeeping">Bookkeeping

</a>- Compliance Advice [JSON](./skills/compliance-advice.skill.json)
...
<a id="budgeting">Budgeting

</a>- Activity-Based Costing Budget Creation [JSON](./skills/activity-based-costing-budget-creation.skill.json)
...
<a id="businessacumen">Business Acumen

</a>- Disaster Recovery Planning [JSON](./skills/disaster-recovery-planning.skill.json)
...
<a id="businessadministration">Business Administration

</a>- Business Report Preparation [JSON](./skills/business-report-preparation.skill.json)
- Standards Implementation [JSON](./skills/standards-implementation.skill.json)

[Back to Top](#skills)


<a id="businessdevelopment">Business Development

</a>- New Business and Business Growth Strategy Development [JSON](./skills/new-business-and-business-growth-strategy-development.skill.json)

[Back to Top](#skills)


<a id="businessethics">Business Ethics

</a>- Code Modification [JSON](./skills/code-modification.skill.json)
...
<a id="businessoperations">Business Operations

</a>- PeopleSoft Financial Application Deployment [JSON](./skills/peoplesoft-financial-application-deployment.skill.json)
...
<a id="businessprocessmanagement">Business Process Management

</a>- Business Operation Process Creation [JSON](./skills/business-operation-process-creation.skill.json)
...
<a id="businessstrategies">Business Strategies

</a>- SWOT (strengths, weaknesses, opportunities, and threats) Analysis [JSON](./skills/swot-strengths-weaknesses-opportunities-and-threats-analysis.skill.json)

[Back to Top](#skills)


<a id="calculations">Calculations

</a>- Financial Health Assessment [JSON](./skills/financial-health-assessment.skill.json)

[Back to Top](#skills)


<a id="casemanagement">Case Management

</a>- Case Management Application [JSON](./skills/case-management-application.skill.json)
...
<a id="cashflowanalysis">Cash Flow Analysis

</a>- Cash Flow Analysis Liquidity [JSON](./skills/cash-flow-analysis-liquidity.skill.json)
...
<a id="causalinference">Causal Inference

</a>- Causal and Non-Causal Differentiation [JSON](./skills/causal-and-non-causal-differentiation.skill.json)
...
<a id="certifiedpublicaccountant">Certified Public Accountant

</a>- Accounting Control Completion [JSON](./skills/accounting-control-completion.skill.json)
...
<a id="changemanagement">Change Management

</a>- Change Management Technique Application [JSON](./skills/change-management-technique-application.skill.json)

[Back to Top](#skills)


<a id="circular230">Circular 230

</a>- Client Interests Protection [JSON](./skills/client-interests-protection.skill.json)
...
<a id="collections">Collections

</a>- Delinquent Accounts Inquiry [JSON](./skills/delinquent-accounts-inquiry.skill.json)
...
<a id="commercialfinance">Commercial Finance

</a>- Commercial Credit Portfolio Application [JSON](./skills/commercial-credit-portfolio-application.skill.json)
...
<a id="communications">Communications

</a>- Communications Distribution Management [JSON](./skills/communications-distribution-management.skill.json)
...
<a id="computerliteracy">Computer Literacy

</a>- Operating System and Utility Settings Configuration [JSON](./skills/operating-system-and-utility-settings-configuration.skill.json)

[Back to Top](#skills)


<a id="conflictresolution">Conflict Resolution

</a>- Team Member Conflict Resolution [JSON](./skills/team-member-conflict-resolution.skill.json)

[Back to Top](#skills)


<a id="consolidation">Consolidation

</a>- Acquisition Workpaper Consolidation Preparation [JSON](./skills/acquisition-workpaper-consolidation-preparation.skill.json)
...
<a id="continuousimprovementprocess">Continuous Improvement Process

</a>- Business Operations Analysis [JSON](./skills/business-operations-analysis.skill.json)
...
<a id="cooperation">Cooperation

</a>- Common Objective Collaboration [JSON](./skills/common-objective-collaboration.skill.json)
...
<a id="coordinating">Coordinating

</a>- Common Goal Identification [JSON](./skills/common-goal-identification.skill.json)
...
<a id="corporateaccounting">Corporate Accounting

</a>- Accounting Documentation [JSON](./skills/accounting-documentation.skill.json)
...
<a id="corporatefinance">Corporate Finance

</a>- Capital Budgeting Methods [JSON](./skills/capital-budgeting-methods.skill.json)
- Working Capital Measurement [JSON](./skills/working-capital-measurement.skill.json)

[Back to Top](#skills)


<a id="costaccounting">Cost Accounting

</a>- Business Unit Profitability Requirements Analysis [JSON](./skills/business-unit-profitability-requirements-analysis.skill.json)
...
<a id="costbenefitanalysis">Cost Benefit Analysis

</a>- Actual Variance Reporting [JSON](./skills/actual-variance-reporting.skill.json)
...
<a id="creativethinking">Creative Thinking

</a>- Devise Efficient Business Processes [JSON](./skills/devise-efficient-business-processes.skill.json)
...
<a id="creativity">Creativity

</a>- Develop Ideas to Solve Problems [JSON](./skills/develop-ideas-to-solve-problems.skill.json)
...
<a id="creditanalysis">Credit Analysis

</a>- Client Monitoring Process Implementation [JSON](./skills/client-monitoring-process-implementation.skill.json)
...
<a id="creditrisk">Credit Risk

</a>- Conduct Credit Risk Management [JSON](./skills/conduct-credit-risk-management.skill.json)
...
<a id="criminaljustice">Criminal Justice

</a>- Accounting Software Implementation [JSON](./skills/accounting-software-implementation.skill.json)
...
<a id="criticalthinking">Critical Thinking

</a>- Apply Logic and Reasoning Techniques [JSON](./skills/apply-logic-and-reasoning-techniques.skill.json)
...
<a id="culturalsensitivity">Cultural Sensitivity

</a>- Display Attitude and Belief Awareness [JSON](./skills/display-attitude-and-belief-awareness.skill.json)

[Back to Top](#skills)


<a id="culturallysensitive">Culturally Sensitive

</a>- Assumption and Bias Awareness Demonstration [JSON](./skills/assumption-and-bias-awareness-demonstration.skill.json)
- Attitude and Belief Awareness Demonstration [JSON](./skills/attitude-and-belief-awareness-demonstration.skill.json)

[Back to Top](#skills)


<a id="customeraccounts">Customer Accounts

</a>- Customer Account Record Management [JSON](./skills/customer-account-record-management.skill.json)
...
<a id="customerbilling">Customer Billing

</a>- Account Invoicing and Reconciliation Performance [JSON](./skills/account-invoicing-and-reconciliation-performance.skill.json)
...
<a id="customerrelationshipmanagement">Customer Relationship Management

</a>- Conduct Customer Contact Training [JSON](./skills/conduct-customer-contact-training.skill.json)
...
<a id="customerservice">Customer Service

</a>- Customer Concern Escalation [JSON](./skills/customer-concern-escalation.skill.json)
...
<a id="dataanalysis">Data Analysis

</a>- Company Financial Data Analysis [JSON](./skills/company-financial-data-analysis.skill.json)
...
<a id="datacollection">Data Collection

</a>- ARCHIVED - Effective Information Gathering [JSON](./skills/archived-effective-information-gathering.skill.json)
...
<a id="dataentry">Data Entry

</a>- Data Accuracy Validation [JSON](./skills/data-accuracy-validation.skill.json)
...
<a id="datavisualization">Data Visualization

</a>- Analytical Goal Spreadsheet Modification [JSON](./skills/analytical-goal-spreadsheet-modification.skill.json)
...
<a id="datarecordlogging">Data/Record Logging

</a>- Conduct Records Management (RM) Annual Reviews [JSON](./skills/conduct-records-management-rm-annual-reviews.skill.json)
...
<a id="decisionmaking">Decision Making

</a>- Decision-Making Procedure Development [JSON](./skills/decision-making-procedure-development.skill.json)
...
<a id="deductivereasoning">Deductive Reasoning

</a>- Draw Conclusions from Premises [JSON](./skills/draw-conclusions-from-premises.skill.json)
...
<a id="detailoriented">Detail Oriented

</a>- Human Resource Project Progress Monitoring [JSON](./skills/human-resource-project-progress-monitoring.skill.json)
...
<a id="documentmanagementsystems">Document Management Systems

</a>- Document Validity Verification [JSON](./skills/document-validity-verification.skill.json)
...
<a id="econometrics">Econometrics

</a>- Data Relationship Extraction Analysis [JSON](./skills/data-relationship-extraction-analysis.skill.json)
- Economic Trend Forecasting [JSON](./skills/economic-trend-forecasting.skill.json)

[Back to Top](#skills)


<a id="economicanalysis">Economic Analysis

</a>- Define Economic Climate Picture [JSON](./skills/define-economic-climate-picture.skill.json)
...
<a id="economicdevelopment">Economic Development

</a>- Economic Development Effort Leadership [JSON](./skills/economic-development-effort-leadership.skill.json)
- Economic Productivity Component Identification [JSON](./skills/economic-productivity-component-identification.skill.json)

[Back to Top](#skills)


<a id="economictheories">Economic Theories

</a>- Economic Behavior Interpretation [JSON](./skills/economic-behavior-interpretation.skill.json)

[Back to Top](#skills)


<a id="economics">Economics

</a>- Economic Business Factor Impact Analysis [JSON](./skills/economic-business-factor-impact-analysis.skill.json)
...
<a id="emotionalintelligence">Emotional Intelligence

</a>- Perspective Recognition [JSON](./skills/perspective-recognition.skill.json)

[Back to Top](#skills)


<a id="enterpriseresourceplanning">Enterprise Resource Planning

</a>- Analyze Enterprise Resource Planning (ERP) General Ledger (GL) Entries [JSON](./skills/analyze-enterprise-resource-planning-erp-general-ledger-gl-entries.skill.json)
...
<a id="externalauditor">External Auditor

</a>- Audit Findings Communication [JSON](./skills/audit-findings-communication.skill.json)
...
<a id="finance">Finance

</a>- Financial Tools and Techniques [JSON](./skills/financial-tools-and-techniques.skill.json)

[Back to Top](#skills)


<a id="financialaccounting">Financial Accounting

</a>- Balance Sheet Maintenance [JSON](./skills/balance-sheet-maintenance.skill.json)
...
<a id="financialaccountingstandardsboard">Financial Accounting Standards Board

</a>- Ensure Calculations and Disclosures Compliance [JSON](./skills/ensure-calculations-and-disclosures-compliance.skill.json)
...
<a id="financialanalysis">Financial Analysis

</a>- Financial Data Review [JSON](./skills/financial-data-review.skill.json)
...
<a id="financialauditing">Financial Auditing

</a>- Accounting Systems Inspection [JSON](./skills/accounting-systems-inspection.skill.json)
...
<a id="financialdata">Financial Data

</a>- Company Data Collection [JSON](./skills/company-data-collection.skill.json)
...
<a id="financialmanagement">Financial Management

</a>- Financial Documents Management [JSON](./skills/financial-documents-management.skill.json)
...
<a id="financialmarket">Financial Market

</a>- Conduct Financial Market Transactions [JSON](./skills/conduct-financial-market-transactions.skill.json)
...
<a id="financialreporting">Financial Reporting

</a>- Annual Financial Report Elements Identification [JSON](./skills/annual-financial-report-elements-identification.skill.json)
...
<a id="financialservices">Financial Services

</a>- Cost Benefit Analysis [JSON](./skills/cost-benefit-analysis.skill.json)
...
<a id="financialstatementanalysis">Financial Statement Analysis

</a>- Financial Statement Decision Making Analysis [JSON](./skills/financial-statement-decision-making-analysis.skill.json)
- Financial Statement Decision Making Review [JSON](./skills/financial-statement-decision-making-review.skill.json)

[Back to Top](#skills)


<a id="financialstatements">Financial Statements

</a>- Balance Sheet and Income Statement Financial Statements Creation [JSON](./skills/balance-sheet-and-income-statement-financial-statements-creation.skill.json)
...
<a id="financialtrading">Financial Trading

</a>- Monthly and Quarterly Financial Statements Analysis [JSON](./skills/monthly-and-quarterly-financial-statements-analysis.skill.json)
...
<a id="financialtransactions">Financial Transactions

</a>- Financial Transactions Recording [JSON](./skills/financial-transactions-recording.skill.json)

[Back to Top](#skills)


<a id="fixedasset">Fixed Asset

</a>- Audit Schedules Preparation [JSON](./skills/audit-schedules-preparation.skill.json)
...
<a id="forecasting">Forecasting

</a>- Compiled Data Analysis [JSON](./skills/compiled-data-analysis.skill.json)
...
<a id="generalfundenterprisebusinesssystemsgfebs">General Fund Enterprise Business Systems (GFEBS)

</a>- Army's Business Processes Improvements Design [JSON](./skills/armys-business-processes-improvements-design.skill.json)
...
<a id="generalledger">General Ledger

</a>- Accounting Controls Development [JSON](./skills/accounting-controls-development.skill.json)
...
<a id="generalledgerglaccounting">General Ledger (GL) Accounting

</a>- Account Balance Integrity Verification [JSON](./skills/account-balance-integrity-verification.skill.json)
...
<a id="generallyacceptedaccountingprinciples">Generally Accepted Accounting Principles

</a>- Accounting and Reporting Differences Identification [JSON](./skills/accounting-and-reporting-differences-identification.skill.json)
...
<a id="humanresourcemanagement">Human Resource Management

</a>- Senior Managers Organizational Policy Advisement [JSON](./skills/senior-managers-organizational-policy-advisement.skill.json)
...
<a id="humanresourcepolicies">Human Resource Policies

</a>- Record-Keeping Procedures Development [JSON](./skills/record-keeping-procedures-development.skill.json)

[Back to Top](#skills)


<a id="inductivereasoning">Inductive Reasoning

</a>- Conditional Probability Functions Employment [JSON](./skills/conditional-probability-functions-employment.skill.json)
...
<a id="industryanalysis">Industry Analysis

</a>- Market Analysis Development [JSON](./skills/market-analysis-development.skill.json)
...
<a id="informationordering">Information Ordering

</a>- Chronology Set Improvement [JSON](./skills/chronology-set-improvement.skill.json)
...
<a id="informationprivacy">Information Privacy

</a>- Data Classification [JSON](./skills/data-classification.skill.json)
- Ensure Information Privacy Compliance [JSON](./skills/ensure-information-privacy-compliance.skill.json)

[Back to Top](#skills)


<a id="informationtechnology">Information Technology

</a>- Data Manipulation [JSON](./skills/data-manipulation.skill.json)
- Technology Solutions Delivery Collaboration [JSON](./skills/technology-solutions-delivery-collaboration.skill.json)

[Back to Top](#skills)


<a id="infrastructure">Infrastructure

</a>- Infrastructure Budgets Development [JSON](./skills/infrastructure-budgets-development.skill.json)
- Network Systems Troubleshooting [JSON](./skills/network-systems-troubleshooting.skill.json)

[Back to Top](#skills)


<a id="innovation">Innovation

</a>- Creative Solutions Proposal [JSON](./skills/creative-solutions-proposal.skill.json)
...
<a id="intellectualproperty">Intellectual Property

</a>- Liability Risks Elements Identification [JSON](./skills/liability-risks-elements-identification.skill.json)
- Risk-Avoidance Policies Development [JSON](./skills/risk-avoidance-policies-development.skill.json)

[Back to Top](#skills)


<a id="internalauditing">Internal Auditing

</a>- Analyze Policies Promoting Objectivity [JSON](./skills/analyze-policies-promoting-objectivity.skill.json)
...
<a id="internationalbusiness">International Business

</a>- International Business Issues Recognition [JSON](./skills/international-business-issues-recognition.skill.json)

[Back to Top](#skills)


<a id="monthEndcloseprocesses">Month-End Close Processes

</a>- Temporary Account Closing [JSON](./skills/temporary-account-closing.skill.json)

[Back to Top](#skills)


<a id="operationalrisk">Operational Risk

</a>- Risk Reports Preparation [JSON](./skills/risk-reports-preparation.skill.json)

[Back to Top](#skills)


<a id="operations">Operations

</a>- Develop a Capacity Management Plan [JSON](./skills/develop-a-capacity-management-plan.skill.json)
...
<a id="organizationalstructure">Organizational Structure

</a>- Organizational Structure Implementation [JSON](./skills/organizational-structure-implementation.skill.json)
- Organizational Structures Recognition [JSON](./skills/organizational-structures-recognition.skill.json)

[Back to Top](#skills)


<a id="payrollprocessing">Payroll Processing

</a>- Conduct Payroll Processing [JSON](./skills/conduct-payroll-processing.skill.json)
...
<a id="performanceappraisal">Performance Appraisal

</a>- Behavior Modification Help [JSON](./skills/behavior-modification-help.skill.json)
...
<a id="performancemanagement">Performance Management

</a>- Company Performance Reports Analysis [JSON](./skills/company-performance-reports-analysis.skill.json)
...
<a id="personalfinance">Personal Finance

</a>- Financial Principles Application [JSON](./skills/financial-principles-application.skill.json)

[Back to Top](#skills)


<a id="policyresearchandanalysis">Policy Research And Analysis

</a>- Policy Options Comparison [JSON](./skills/policy-options-comparison.skill.json)
...
<a id="presentations">Presentations

</a>- Ensure Presentation Consistency [JSON](./skills/ensure-presentation-consistency.skill.json)
...
<a id="preventivemaintenance">Preventive Maintenance

</a>- Assets Maintenance Recommendation [JSON](./skills/assets-maintenance-recommendation.skill.json)
...
<a id="problemsolving">Problem Solving

</a>- Accounting Problem Information Collection [JSON](./skills/accounting-problem-information-collection.skill.json)
...
<a id="processimprovement">Process Improvement

</a>- Six Sigma Implementation [JSON](./skills/six-sigma-implementation.skill.json)
- Work Instructions Development [JSON](./skills/work-instructions-development.skill.json)

[Back to Top](#skills)


<a id="procurement">Procurement

</a>- Financial Analysis [JSON](./skills/financial-analysis.skill.json)
...
<a id="propertytax">Property Tax

</a>- Property Tax Assessments Analysis [JSON](./skills/property-tax-assessments-analysis.skill.json)
...
<a id="publicadministration">Public Administration

</a>- Laws Implementation Analysis [JSON](./skills/laws-implementation-analysis.skill.json)
...
<a id="publicpolicies">Public Policies

</a>- Challenge Identification [JSON](./skills/challenge-identification.skill.json)
...
<a id="quantitativeanalysis">Quantitative Analysis

</a>- Data Summary Tools [JSON](./skills/data-summary-tools.skill.json)
...
<a id="regulatorycompliance">Regulatory Compliance

</a>- Compile Operational Account Information [JSON](./skills/compile-operational-account-information.skill.json)
...
<a id="relationaldatabases">Relational Databases

</a>- Arrange Data into Tables [JSON](./skills/arrange-data-into-tables.skill.json)
- Data Normalization [JSON](./skills/data-normalization.skill.json)

[Back to Top](#skills)


<a id="research">Research

</a>- Accounting Issues Research [JSON](./skills/accounting-issues-research.skill.json)
...
<a id="riskanalysis">Risk Analysis

</a>- Liability Reporting Process Establishment [JSON](./skills/liability-reporting-process-establishment.skill.json)
...
<a id="riskmanagement">Risk Management

</a>- Asset Risks Identification [JSON](./skills/asset-risks-identification.skill.json)
...
<a id="riskreduction">Risk Reduction

</a>- Risk Action Planning [JSON](./skills/risk-action-planning.skill.json)
...
<a id="sqlprogramminglanguage">SQL (Programming Language)

</a>- Custom Queries Design Oversight [JSON](./skills/custom-queries-design-oversight.skill.json)
...
</a>- List Performance Obligations [JSON](./skills/list-performance-obligations.skill.json)
...
<a id="sarbanesOxleyactsoxcompliance">Sarbanes-Oxley Act (SOX) Compliance

</a>- Compliance Testing Execution [JSON](./skills/compliance-testing-execution.skill.json)
...
<a id="scheduling">Scheduling

</a>- Accounting Schedules Report Creation [JSON](./skills/accounting-schedules-report-creation.skill.json)
...
<a id="securitiesfinance">Securities (Finance)

</a>- Equities Analysis [JSON](./skills/equities-analysis.skill.json)
...
<a id="sixsigmamethodology">Six Sigma Methodology

</a>- Standard Operating Procedure (SOP) Implementation [JSON](./skills/standard-operating-procedure-sop-implementation.skill.json)

[Back to Top](#skills)


<a id="socialskills">Social Skills

</a>- Dispute Resolution [JSON](./skills/dispute-resolution.skill.json)
...
<a id="spreadsheets">Spreadsheets

</a>- Add Complex Formulas [JSON](./skills/add-complex-formulas.skill.json)
...
<a id="staffmanagement">Staff Management

</a>- Accounting Processes Oversight [JSON](./skills/accounting-processes-oversight.skill.json)
...
<a id="statisticalinference">Statistical Inference

</a>- Cox Regression Analysis [JSON](./skills/cox-regression-analysis.skill.json)
...
<a id="statisticalmodeling">Statistical Modeling

</a>- Statistical Analysis Application [JSON](./skills/statistical-analysis-application.skill.json)
...
<a id="statisticalpackages">Statistical Packages

</a>- Basic Inferential Analysis [JSON](./skills/basic-inferential-analysis.skill.json)
...
</a>- Create Insightful Visualizations [JSON](./skills/create-insightful-visualizations.skill.json)
...
<a id="statutoryaccountingprinciples">Statutory Accounting Principles

</a>- Annual Report Entry [JSON](./skills/annual-report-entry.skill.json)
...
<a id="strategicplanning">Strategic Planning

</a>- Business Strategy Development [JSON](./skills/business-strategy-development.skill.json)
...
<a id="suspiciousactivityreport">Suspicious Activity Report

</a>- Financial Suspicions Communication Procedures Design [JSON](./skills/financial-suspicions-communication-procedures-design.skill.json)
...
<a id="taxaccounting">Tax Accounting

</a>- Client Financial Statements Review [JSON](./skills/client-financial-statements-review.skill.json)
...
<a id="taxanalysis">Tax Analysis

</a>- Business Decision Impact Determination [JSON](./skills/business-decision-impact-determination.skill.json)
...
<a id="taxcompliance">Tax Compliance

</a>- Audit Investigations Planning [JSON](./skills/audit-investigations-planning.skill.json)
...
<a id="taxlaws">Tax Laws

</a>- Business Tax Law Advice [JSON](./skills/business-tax-law-advice.skill.json)
...
<a id="taxplanning">Tax Planning

</a>- Cash Flow Forecasting [JSON](./skills/cash-flow-forecasting.skill.json)
...
<a id="taxpreparation">Tax Preparation

</a>- Accessible Tax Preparation Information [JSON](./skills/accessible-tax-preparation-information.skill.json)
...
<a id="taxresearch">Tax Research

</a>- Financial Planning Guidance [JSON](./skills/financial-planning-guidance.skill.json)
...
<a id="taxreturn">Tax Return

</a>- Audit Representation [JSON](./skills/audit-representation.skill.json)
...
<a id="taxwaresoftware">Taxware (Software)

</a>- Business Tax Returns Preparation [JSON](./skills/business-tax-returns-preparation.skill.json)
...
<a id="teamleadership">Team Leadership

</a>- Quality of Care Improvement Motivation [JSON](./skills/quality-of-care-improvement-motivation.skill.json)
...
<a id="timemanagement">Time Management

</a>- Apply Time Management Techniques [JSON](./skills/apply-time-management-techniques.skill.json)
...
<a id="tortlaw">Tort Law

</a>- Determine Scope Risks [JSON](./skills/determine-scope-risks.skill.json)
...
<a id="traininganddevelopment">Training And Development

</a>- Lead Internal Employee Training [JSON](./skills/lead-internal-employee-training.skill.json)

[Back to Top](#skills)


<a id="troubleshootingproblemsolving">Troubleshooting (Problem Solving)

</a>- Accounting Errors Troubleshooting Guidelines [JSON](./skills/accounting-errors-troubleshooting-guidelines.skill.json)
...
<a id="varianceanalysis">Variance Analysis

</a>- Budget Adjustments Advisement [JSON](./skills/budget-adjustments-advisement.skill.json)
...
<a id="verbalcommunicationskills">Verbal Communication Skills

</a>- Active Listening Demonstration [JSON](./skills/active-listening-demonstration.skill.json)
...
<a id="writtencommunication">Written Communication

</a>- Critical Thinking Writing [JSON](./skills/critical-thinking-writing.skill.json)
